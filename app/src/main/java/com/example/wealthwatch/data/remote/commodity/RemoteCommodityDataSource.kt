...
class RemoteCommodityDataSource @Inject constructor(
    ...
    override fun getCommodities(): Flow<Resource<List<Commodities>>> =
    ...
    override fun searchCommodities(query: String): Flow<Resource<List<Commodities>>> =
    ...
    override fun getCommoditiesGainers(): Flow<Resource<List<Commodities>>> =
    ...
    override fun getCommoditiesLosers(): Flow<Resource<List<Commodities>>> =
